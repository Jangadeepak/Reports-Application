...
public class ExcelGenerator {
	...
	public void generateExcel(HttpServletResponse response,List<CitizenPlan> records ,File f) throws Exception{
		
		Workbook workbook = new HSSFWorkbook();
		  Sheet createSheet = workbook.createSheet("plan-data");
